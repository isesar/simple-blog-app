...
export const metadata: Metadata = {
    title: 'About',
    description:
        'Learn more about Simple Blog, its features, tech stack, and how to use it.',
    ...
    return (
        <main className="mx-auto max-w-5xl px-4 sm:px-6 py-8">
            ...
            <div className="prose dark:prose-invert max-w-none space-y-6">
                <p>
                    Simple Blog is a small demo application showcasing how to
                    build a modern, responsive UI with
                    <strong> Next.js</strong>, <strong>React</strong>,{' '}
                    <strong>TypeScript</strong>, and{' '}
                    <strong>Tailwind CSS</strong>. It focuses on clear
                    structure, maintainable state management, and accessible,
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                        <li>
                            Next.js App Router (routing, layouts, client
                            components)
                        </li>
                        ...
                        <li>
                            Radix UI + shadcn-inspired primitives for accessible
                            components
                        </li>
                ...
                <section>
                    ...
                    <ol className="list-decimal pl-6 space-y-1">
                        ...
                        <li>
                            Open any post to view details; use the actions to
                            edit or delete.
                        </li>
